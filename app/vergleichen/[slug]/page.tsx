  ...
  const tools = [
    {
      ...
      farbe: TOOL_FARBEN[0],
      preis: formatPreis(comparison.toolA.startingPriceCents, { prefix: 'ab', suffix: '/ Monat' }),
    ...
    },
    {
      ...
      farbe: TOOL_FARBEN[1],
      preis: formatPreis(comparison.toolB.startingPriceCents, { prefix: 'ab', suffix: '/ Monat' }),
