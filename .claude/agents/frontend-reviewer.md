...
description: Prüft fertigen Frontend-Code auf Wartbarkeit, Zugänglichkeit, Responsivität und Design-Treue. Nach jeder abgeschlossenen UI-Aufgabe einsetzen, bevor etwas freigegeben oder committet wird. Meldet Befunde, ändert selbst nichts.
